...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("Valider");
    			add_location(input0, file$1, 5, 1, 70);
    			add_location(input1, file$1, 6, 1, 98);
    			button.disabled = button_disabled_value = !/*appId*/ ctx[0] || !/*apiKey*/ ctx[1];
    			add_location(button, file$1, 7, 1, 127);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ appId, apiKey });
    	...
    	return [appId, apiKey, input0_input_handler, input1_input_handler];
    }
    ...
    /* src/ui/Test.svelte generated by Svelte v3.48.0 */

    const file = "src/ui/Test.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	route0 = new Route({
    			props: { path: "about", component: Test },
    			$$inline: true
    		});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Router, Route, Login, Test, url });
