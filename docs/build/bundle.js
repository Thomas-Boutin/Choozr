...
var app = (function () {
    ...
    var RouteEventDetail;
    (function (RouteEventDetail) {
        RouteEventDetail[RouteEventDetail["Logged"] = 0] = "Logged";
        RouteEventDetail[RouteEventDetail["ChoozrCreated"] = 1] = "ChoozrCreated";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text("Valider");
    			add_location(input0, file$1, 14, 2, 464);
    			add_location(input1, file$1, 15, 2, 495);
    			button.disabled = button_disabled_value = !/*appId*/ ctx[0] || !/*apiKey*/ ctx[1];
    			add_location(button, file$1, 16, 2, 527);
    			attr_dev(main, "class", "svelte-177t831");
    			add_location(main, file$1, 13, 0, 455);
    		},
    		l: function claim(nodes) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function valider() {
    		...
    		dispatch("routeEvent", RouteEventDetail.Logged);
    	}
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 14, 2, 514);
    			add_location(main, file, 12, 0, 469);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function createChoozr() {
    		...
    		dispatch("routeEvent", RouteEventDetail.ChoozrCreated);
    	}
